...
void test_file_bin_filename() {
    ...
    IS(file_bin_filename("dir/x.asm"), "dir/xxx");
    IS(file_bin_filename("/dir/x.asm"), "/dir/xxx");
    IS(file_bin_filename("\\dir\\x.asm"), "/dir/xxx");
    IS(file_bin_filename("c:\\dir\\x.asm"), "c:/dir/xxx");
    ...
    IS(file_bin_filename("dir/x.asm"), "dir/x.P");
    IS(file_bin_filename("/dir/x.asm"), "/dir/x.P");
    IS(file_bin_filename("\\dir\\x.asm"), "/dir/x.P");
    IS(file_bin_filename("c:\\dir\\x.asm"), "c:/dir/x.P");
    ...
    IS(file_bin_filename("dir/x.asm", "CODE"), "dir/xxx_CODE.bin");
    IS(file_bin_filename("/dir/x.asm", "CODE"), "/dir/xxx_CODE.bin");
    IS(file_bin_filename("\\dir\\x.asm", "CODE"), "/dir/xxx_CODE.bin");
    IS(file_bin_filename("c:\\dir\\x.asm", "CODE"), "c:/dir/xxx_CODE.bin");
